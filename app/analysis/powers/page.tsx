...
export default function PowersAnalysisPage() {
  ...
  const handleFile = async (file) => {
    ...
    try {
      ...
      formData.append('analysisType', 'powers')
          ...
          {result && (
            <div className="space-y-6">
              ...
              <Card className="p-6 space-y-6">
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-4">Informe de Poderes</h2>
